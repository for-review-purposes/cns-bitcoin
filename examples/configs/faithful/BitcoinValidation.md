...
- This document can be reproduced from preexisting data via “knitting”
  <https://github.com/for-review-purposes/cns-bitcoin/blob/main/examples/configs/faithful/BitcoinValidation.Rmd>
...
- Configuration file(s):
  <https://github.com/for-review-purposes/cns-bitcoin/blob/main/examples/configs/faithful/bitcoin.faithful.30node.30sim.XX-XX.properties>
  (where `XX` is to be replaced with the Simulation ID)
- Workload:
  <https://github.com/for-review-purposes/cns-bitcoin/blob/main/examples/configs/faithful/bitcoin.faithful-workload.csv>
- Data:
  <https://github.com/for-review-purposes/cns-bitcoin/tree/main/examples/results/faithful>
...
need to convert this Bitcoin-specific difficulty to CNS difficulty
...
likely deviate from the original total hashpower measurement. CNS
